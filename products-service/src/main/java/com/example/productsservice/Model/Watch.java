...
@Document(collection = "all-watches")
public class Watch{
    @Id
    ...
    private List<WatchFeaturesWithImage> watchFeatures;
    ...
    public Watch(long watchId, String gender, String watchType, String imageWatchCard, String model, String desc, int price, String strPrice, String imageBackground, String imageWatch, String nightImage, StaticTextShortAbout staticTextShortAbout, List<WatchFeaturesWithImage> watchFeatures, String rolexBoxImage, ModelCase modelCase, WatchMovement watchMovement, WatchBracelet watchBracelet, WatchDial watchDial, WatchCertification watchCertification, String orderBackgroundImage) {
    ...
    public List<WatchFeaturesWithImage> getWatchFeatures() {
        return watchFeatures;
    }

    public void setWatchFeatures(List<WatchFeaturesWithImage> watchFeatures) {
        this.watchFeatures = watchFeatures;
    }
